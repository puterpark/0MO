...
<div class="col-lg-9">
	...
	<form action="/my_body_paysearchlook.do" method="get" id="userpaysearch">
		<div class="container">
			<div style="float:left; width:30%;">
				<button class="btn btn-quaternary mb-2" type="button" 
				style="width:120pt; height:25pt;" onclick="location.href='/my_body_paylook.do'">결제 전체내역조회</button>
			</div>
	...
	<div class="container">
			<table class="table table-hover">
				...
				<tbody>
					<c:forEach items="${LVL_USERPAYLIST}" var="apovo">
						<tr>
							<td>${apovo.paregdate}</td>
							<td>${apovo.ptname}</td>
							<td>${apovo.pamoney}</td>
						</tr>
					</c:forEach>
