...
<div role="main" class="main">
	<div class="container">
		...
		<div>
			...
			style="width:120pt; height:25pt;" onclick="location.href='/admin_pay.do'">결제 전체내역조회</button>
		</div>
		
		<form action="/admin_pay_search.do" method="get" id="adminsearch">
			<table>
				<tr>
					<th>
				...
				<tr>
					...
					<div class="input-group input-search">
						...
						<span class="input-group-btn">
							<button class="btn btn-default" type="button" id="apas"><i class="fa fa-search"></i></button>
						</span>
					</div>
				</th>	
				</tr>
	...
	<div class="container">
			<table class="table table-hover">
				...
				<tbody>
					<c:forEach items="${LVL_APAYLIST}" var="apavo">
						<tr>
							<td>${apavo.mseq}</td>
							<td>${apavo.mid}</td>
							<td>${apavo.pamoney}</td>
							<td>${apavo.paregdate}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
