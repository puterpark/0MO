...
<div class="col-lg-3">
	<aside class="sidebar" id="sidebar">
		<h4 class="heading-primary"><a class="nav-link" href="/guin2.do">전체보기</a></h4>
		<ul class="nav nav-list flex-column narrow">
			...
			<li class="nav-item"><a class="nav-link" href="#">웹기획</a></li>
			<li class="nav-item"><a class="nav-link" href="#">웹개발</a></li>
			<li class="nav-item"><a class="nav-link" href="#">앱개발</a></li>
